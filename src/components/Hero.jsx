          ...
          <div className="hero-right" style={{ position: 'relative', display: 'flex', justifyContent: 'center' }}>
            <div style={{
                ...
                <div style={{
                  ...
                  <img
                    ...
                    onError={e => {
                      ...
                      e.target.parentNode.style.background = 'linear-gradient(135deg, var(--orange), var(--yellow))'
                      e.target.parentNode.innerHTML = '<span style="color:white;font-weight:800;font-size:2rem">K</span>'
                    }}
                  />
                </div>
              ...
              {[
                ...
                { icon: <Leaf size={20} color="var(--orange)"/>, label: 'Semen Portland', desc: 'Perekat dari kawasan Lhoknga', color: 'var(--orange)' },
              ].map((item, i) => (
                <div key={i} style={{
