...
import { Droplets, Sun, FlaskConical, Box, Home, Ruler, Shovel, Scale, Filter, Blend, Thermometer } from 'lucide-react'
      ...
      <div className="container">
        ...
        <div style={{ textAlign: 'center', marginBottom: '64px' }}>
          ...
          <p className="section-subtitle" style={{ margin: '0 auto', textAlign: 'center' }}>
            5 tahap produksi yang dirancang sistematis untuk menghasilkan
            batu bata berkualitas tinggi dari bahan limbah lokal.
          </p>
        </div>

        <div className="proses-grid" style={{
          display: 'grid', gridTemplateColumns: '1fr 1.4fr',
          gap: '32px', alignItems: 'start', marginBottom: '64px',
        }}>
          {/* Step List */}
          ...
          {/* Step Detail */}
          <div className="proses-detail" style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '14px', marginBottom: '20px' }}>
              <div style={{
                ...
                display: 'flex', alignItems: 'center', justifyContent: 'center',
                color: steps[activeStep].color, flexShrink: 0,
            ...
            <p style={{ color: 'var(--gray)', lineHeight: 1.8, fontSize: '0.92rem', marginBottom: '16px' }}>
              {steps[activeStep].desc}
            </p>
            <div style={{
              background: steps[activeStep].bg, borderRadius: '14px',
              padding: '16px', borderLeft: `4px solid ${steps[activeStep].color}`,
            }}>
              <div style={{
                fontSize: '0.7rem', fontWeight: 700,
                color: steps[activeStep].color,
              ...
              <p style={{ color: 'var(--dark)', lineHeight: 1.7, fontSize: '0.88rem' }}>
        ...
        <div className="alat-grid" style={{
          ...
          {alat.map((item, i) => (
            <div key={i}
              ...
              <div style={{
                width: 44, height: 44, background: 'var(--cream)',
                borderRadius: '10px', display: 'flex',
                alignItems: 'center', justifyContent: 'center',
                margin: '0 auto 10px', color: 'var(--teal)',
              }}>{item.icon}</div>
              <div style={{ fontWeight: 700, fontSize: '0.85rem', marginBottom: '4px' }}>{item.name}</div>
              <div style={{ color: 'var(--gray)', fontSize: '0.75rem' }}>{item.spec}</div>
            </div>
          ))}
        </div>
